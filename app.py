...
<style>
    ...
    .stButton button { background-color: #4f8ef7; color: white; border-radius: 8px; border: none; }
...
with col2:
    if uploaded_file is not None:
        ...
        st.markdown('<p class="sub-text">アップロード後、ここで質問できます。</p>', unsafe_allow_html=True)